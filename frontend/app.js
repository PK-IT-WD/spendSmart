document.addEventListener('DOMContentLoaded', async () => {
    ...
    if (signup) {
        signup.addEventListener('submit', async (event) => {
            ...
            try {
                ...
                const response = await fetch('https://13.127.99.27:443/signup', {
                    method: 'POST',
    ...
    if (login) {
        login.addEventListener('submit', async (event) => {
            ...
            try {
                ...
                const response = await fetch('https://13.127.99.27:443/login', {
                    method: 'POST',
                    headers: {'Content-Type': 'application/json'},
                    body: JSON.stringify(userDetails)
                });
            ...
            forgotPassword.addEventListener('click', () => {
                ...
                if (recoverPassword) {
                    recoverPassword.addEventListener('submit', async (event) => {
                        ...
                        const response = await fetch('https://13.127.99.27:443/recoverPassword', {
                            method: 'POST',
                            headers: {'Content-Type': 'application/json'},
    ...
    if (expenseForm) {
        expenseForm.addEventListener('submit', async (event) => {
            ...
            try {
                ...
                const response = await fetch('https://13.127.99.27:443/addExpense', {
                    method: 'POST',
                    headers: {
    ...
    async function displayAllExpense(page = 1) {
        ...
        try {
            const response = await fetch(`https://13.127.99.27:443/allExpense?page=${page}&limit=${limit}`,
                {
                    method: 'GET',
                    headers: {
                        'Content-Type': 'application/json',
    ...
    async function deleteExpense(id) {
        ...
        try {
            const response = await fetch(`https://13.127.99.27:443/deleteExpense/${id}`,{
                method: 'DELETE',
                headers: { 
                    'Content-Type': 'application/json',
                    'Authorization': `Bearer ${token}`
    ...
    async function checkStatus() {
        ...
        try {
            const response = await fetch('https://13.127.99.27:443/premiumUser', {
                method: 'GET',
                headers: {
                    'Authorization': `Bearer ${token}`
                }
            ...
            if (data.success) {
                ...
                if (incomeButton) {
                    incomeButton.addEventListener('click', async () => {
                        try {
                            const response = await fetch('https://13.127.99.27:443/incomeDetails', {
                                method: 'GET',
                                headers: {
                                    'Authorization': `Bearer ${token}`
                                }
                ...
                if (dailyButton) {
                    dailyButton.addEventListener('click', async() => {
                        try {
                            const response = await fetch('https://13.127.99.27:443/dailyExpense', {
                                method: 'GET',
                                headers: {
                                    'Authorization': `Bearer ${token}` 
                                }
                ...
                if (weeklyButton) {
                    weeklyButton.addEventListener('click', async () => {
                        try {
                            const response = await fetch('https://13.127.99.27:443/weeklyExpense', {
                                method: 'GET',
                                headers: {
                                    'Authorization': `Bearer ${token}`
                                }
                ...
                if (monthlyButton) {
                    monthlyButton.addEventListener('click', async () => {
                        try {
                            const response = await fetch('https://13.127.99.27:443/monthlyExpense', {
                                method: 'GET',
                                headers: {
                                    'Authorization': `Bearer ${token}`
                                }
                ...
                if (downloadButton) {
                    downloadButton.addEventListener('click', async () => {
                        try {
                            const response = await fetch('https://13.127.99.27:443/download', {
                                method: 'GET',
                                headers: {
                                    'Authorization': `Bearer ${token}`
                                }
                ...
                if (leaderboardDiv) {
                    leaderboardButton.addEventListener('click', async () => {
                        try {
                            const response = await fetch('https://13.127.99.27:443/premiumFeature', {
                                method: 'GET'
                            });
                ...
                if (premiumMembership) {
                    premiumMembership.addEventListener('click', async () => {
                        ...
                        try {
                            const response = await fetch('https://13.127.99.27:443/premiumMembership', {
                                method: 'GET',
                                headers: {'Content-Type': 'application/json'}
                            });
                            ...
                            braintree.dropin.create({
                                ...
                                submitPayment.addEventListener('click', async () => {
                                    instance.requestPaymentMethod(async (err, payload) => {
                                        ...
                                        const token = localStorage.getItem('token');
                                        try {
                                            const response = await fetch('https://13.127.99.27:443/createTransaction', {
                                                method: 'POST',
                                                headers: {
                                                    'Content-Type': 'application/json',
                                                    'Authorization': `Bearer ${token}`
    ...
    if (resetPassword) {
        resetPassword.addEventListener('submit', async (event) => {
            ...
            try {
                ...
                const response = await fetch('https://13.127.99.27:443/updatePassword', {
                    method: 'POST',
                    headers: { 'Content-Type': 'application/json' },
